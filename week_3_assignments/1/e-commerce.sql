...
CREATE TABLE `customers`( 
	...
	`salesRepEmployeeNumber` Int( 0 ) NULL DEFAULT NULL,
...
CREATE TABLE `employees`( 
	...
	`reportsTo` Int( 0 ) NULL DEFAULT NULL,
...
CREATE TABLE `orderdetails`( 
	...
	`quantityOrdered` Int( 0 ) NOT NULL,
	`priceEach` Decimal( 10, 2 ) NOT NULL,
	`orderLineNumber` SmallInt( 0 ) NOT NULL,
...
CREATE TABLE `productlines`( 
	...
	`htmlDescription` MediumText CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
CREATE TABLE `products`( 
	...
	`quantityInStock` SmallInt( 0 ) NOT NULL,
...
CREATE INDEX `salesRepEmployeeNumber` USING BTREE ON `customers`( `salesRepEmployeeNumber` );
-- -------------------------------------------------------------


-- CREATE INDEX "officeCode" -----------------------------------
CREATE INDEX `officeCode` USING BTREE ON `employees`( `officeCode` );
-- -------------------------------------------------------------


-- CREATE INDEX "reportsTo" ------------------------------------
CREATE INDEX `reportsTo` USING BTREE ON `employees`( `reportsTo` );
-- -------------------------------------------------------------


-- CREATE INDEX "productCode" ----------------------------------
CREATE INDEX `productCode` USING BTREE ON `orderdetails`( `productCode` );
-- -------------------------------------------------------------


-- CREATE INDEX "customerNumber" -------------------------------
CREATE INDEX `customerNumber` USING BTREE ON `orders`( `customerNumber` );
-- -------------------------------------------------------------


-- CREATE INDEX "productLine" ----------------------------------
CREATE INDEX `productLine` USING BTREE ON `products`( `productLine` );
-- -------------------------------------------------------------


-- CREATE LINK "customers_ibfk_1" ------------------------------
...
-- CREATE LINK "orderdetails_ibfk_1" ---------------------------
...
-- CREATE LINK "orderdetails_ibfk_2" ---------------------------
ALTER TABLE `orderdetails`
